...
# 1. 加载标准甲基橙溶液数据进行模型训练
standard_data_path = '../newData/standard/corrected_standard_orange.xlsx'
...
# 保存标准化器和模型
joblib.dump(pls_absorbance, 'OrangePurple-trained_pls_absorbance_model.pkl')
joblib.dump(pls_concentration, 'OrangePurple-trained_pls_concentration_model.pkl')
joblib.dump(scaler_X_standard, 'OrangePurple-scaler_X_standard.pkl')
joblib.dump(scaler_y_absorbance_standard, 'OrangePurple-scaler_y_absorbance_standard.pkl')
joblib.dump(scaler_y_concentration_standard, 'OrangePurple-scaler_y_concentration_standard.pkl')

# 2. 加载TiO2纳米球数据进行矫正
# 加载检测数据
test_data_path = '../newData/purple/orangeAllData/*.xlsx'
...
# 保存预测结果到 Excel
output_path = '../newData/predicted_results_orange_tiO2.xlsx'
